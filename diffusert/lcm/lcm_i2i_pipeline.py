...
from diffusers import ControlNetModel, AutoencoderKL, ConfigMixin, DiffusionPipeline, SchedulerMixin, UNet2DConditionModel, logging
...
class LatentConsistencyModelImg2ImgPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        if control_image is not None:
            ...
            control_image = self.image_processor.preprocess(image=control_image).to(device=device)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if False:
                    ...
                    print("model_pred size:", model_pred.size())
